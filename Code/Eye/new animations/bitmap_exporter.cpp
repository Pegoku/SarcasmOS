...
constexpr AnimationSpec kAnimations[] = {
    ...
    {"eye-look", ScreenMode::Eyes, 1, 8, 180, "loop"},
    {"eye-alert", ScreenMode::Eyes, 2, 6, 90, "loop"},
    {"eye-angry", ScreenMode::Eyes, 3, 6, 180, "loop"},
    {"eye-surprised", ScreenMode::Eyes, 4, 1, 1000, "loop"},
    {"eye-happy", ScreenMode::Eyes, 5, 1, 1000, "loop"},
    {"eye-suspicious", ScreenMode::Eyes, 6, 6, 220, "loop"},
    {"eye-confused", ScreenMode::Eyes, 7, 1, 1000, "loop"},
    {"eye-dizzy", ScreenMode::Eyes, 8, 8, 120, "loop"},
    {"eye-listening", ScreenMode::Eyes, 9, 8, 140, "loop"},
    ...
    {"clock-alarm", ScreenMode::Clock, 6, 8, 150, "loop"},
    ...
    {"weather-wind", ScreenMode::Weather, 5, 8, 100, "loop"},
    {"weather-fog", ScreenMode::Weather, 6, 8, 100, "loop"},
